...
function buildSegments(values, x, y) {
  ...
  for (let i = 0; i < values.length - 1; i++) {
    ...
    for (const boundary of crossings) {
      ...
      const point = [x(i) + (x(i + 1) - x(i)) * ratio, y(boundary)];
...
function TrendPanel({
  ...
  const geometry = (0, import_react2.useMemo)(() => {
    ...
    return {
      ...
      bandLines: BAND_BOUNDARIES.map((boundary) => ({ boundary, py: y2(boundary) })).filter(({ py }) => py >= PAD.top - 0.5 && py <= TREND_H - PAD.bottom + 0.5)
    };
  }, [points]);
  const head = title !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_mr_trendPanelHead", children: title }) : null;
  if (geometry === null || summary === null) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dsh_mr_trendPanel", children: [
      head,
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_mr_empty", children: emptyText })
    ] });
  }
  const { lo, hi, x, y, last, baseline, segments, bandLines } = geometry;
  const mid = (lo + hi) / 2;
  const hovered = hoverIndex !== null ? points[hoverIndex] : void 0;
  const changeText = summary.direction === "flat" ? "\xB10.0" : `${summary.change > 0 ? "+" : ""}${summary.change.toFixed(1)}`;
  const endpointColor = bandColor(iqBand(points[last][1]));
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dsh_mr_trendPanel", children: [
    head,
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_mr_trendStats", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dsh_mr_trendStat", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh_mr_trendStatLabel", children: t("trend.change") }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { "data-dir": summary.direction, children: changeText })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dsh_mr_trendStat", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh_mr_trendStatLabel", children: t("trend.min") }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: summary.min.toFixed(1) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dsh_mr_trendStat", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh_mr_trendStatLabel", children: t("trend.average") }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: summary.average.toFixed(1) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dsh_mr_trendStat", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh_mr_trendStatLabel", children: t("trend.max") }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: summary.max.toFixed(1) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_mr_trendWrap", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "svg",
        {
          ...
          children: [
            [hi, mid, lo].map((value) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("line", { x1: PAD.left, x2: TREND_W - PAD.right, y1: y(value), y2: y(value), stroke: "var(--dsw-alias-border-l1)", strokeDasharray: value === mid ? "none" : "3 4" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("text", { x: PAD.left - 6, y: y(value) + 3.5, textAnchor: "end", style: AXIS_STYLE, children: value.toFixed(1) })
            ] }, value)),
            bandLines.map(({ boundary, py }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("line", { x1: PAD.left, x2: TREND_W - PAD.right, y1: py, y2: py, stroke: "var(--dsw-alias-border-l2)", strokeDasharray: "2 4" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("text", { x: TREND_W - PAD.right + 6, y: py + 3.5, textAnchor: "start", style: { ...AXIS_STYLE, fontSize: 9 }, children: boundary })
            ] }, boundary)),
            segments.map((segment, index) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: segment.path, fill: "none", stroke: segment.color, strokeWidth: "2", strokeLinejoin: "round", strokeLinecap: "round" })
            ] }, index)),
            hovered !== void 0 && hoverIndex !== null && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("line", { x1: x(hoverIndex), x2: x(hoverIndex), y1: PAD.top, y2: TREND_H - PAD.bottom, stroke: "var(--dsw-alias-border-l2)" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: x(hoverIndex), cy: y(hovered[1]), r: "3", fill: "var(--dsw-alias-bg-layer-1)", stroke: bandColor(iqBand(hovered[1])), strokeWidth: "2" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: x(last), cy: y(points[last][1]), r: "3.8", fill: endpointColor }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("text", { x: x(last), y: y(points[last][1]) - 9, textAnchor: "end", style: { ...AXIS_STYLE, fontWeight: 600, fill: "var(--dsw-alias-label-primary)" }, children: points[last][1].toFixed(1) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("text", { x: PAD.left, y: TREND_H - 8, style: AXIS_STYLE, children: formatStamp(points[0][0], false) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("text", { x: TREND_W - PAD.right, y: TREND_H - 8, textAnchor: "end", style: AXIS_STYLE, children: formatStamp(points[last][0], false) })
          ]
        }
      ),
      hovered !== void 0 && hoverIndex !== null && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_mr_tip", style: { left: `${x(hoverIndex) / TREND_W * 100}%`, top: `${y(hovered[1]) / TREND_H * 100}%` }, children: [
...
function TrendTabs({ points, t }) {
  const [win, setWin] = (0, import_react2.useState)(readTrendWindow);
  const select = (next) => {
    try {
  ...
  const points24 = (0, import_react2.useMemo)(() => sliceRecentPoints(points, 24), [points]);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_mr_tabBody", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_mr_seg", role: "tablist", "aria-label": t("line.title"), children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_mr_segBtn", role: "tab", "aria-selected": win === "24h", "data-active": win === "24h", onClick: () => select("24h"), children: t("window.24h") }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_mr_segBtn", role: "tab", "aria-selected": win === "7d", "data-active": win === "7d", onClick: () => select("7d"), children: t("window.7d") })
    ] }),
    win === "24h" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TrendPanel, { emptyText: t("empty.noRecent"), points: points24, t }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TrendPanel, { emptyText: t("empty.noSeries"), points, t })
  ] });
}
...
function TaskBars({
  ...
  (0, import_react2.useEffect)(() => setFilter("all"), [mode]);
  ...
  const bars = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_mr_bars", children: visible.map(({ row: [taskId, rate], category }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_mr_barRow", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh_mr_barLabel", title: taskId, children: taskId }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_mr_barTrack", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_mr_barFill", "data-band": category, style: { width: `${clamp(rate, 0, 1) * 100}%` } }) }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dsh_mr_barVal", "data-band": category, children: [
      Math.round(rate * 100),
      "%"
    ] })
  ] }, taskId)) });
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_mr_taskSummary", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_mr_taskSummaryHead", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: summary }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: rows.length })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_mr_taskAggregate", role: "img", "aria-label": summary, children: categories.map((category) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { "data-band": category, style: { width: `${counts[category] / Math.max(1, rows.length) * 100}%` } }, category)) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_mr_taskFilters", children: ["all", ...categories].map((category) => {
      const count = category === "all" ? rows.length : counts[category];
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", "data-active": filter === category, "data-band": category, onClick: () => setFilter(category), children: [
        t(FILTER_KEYS[category]),
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: count })
      ] }, category);
    }) }),
    scroll ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PersistentScrollFrame, { viewportClassName: "dsh_mr_taskScroll", label: t("bar.title"), children: bars }) : bars
  ] });
}
...
function TierOverview({ view, selectedKey, currentKey, onSelect, t, scroll = true }) {
  const groups = (0, import_react3.useMemo)(() => groupByBase(view), [view]);
  const [expanded, setExpanded] = (0, import_react3.useState)(() => new Set(basesHidingSelection(groups, selectedKey)));
  ...
  const list = /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh_mr_bars", children: groups.map((group, index) => {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh_mr_ovName", title: group.base, children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh_mr_ovNameText", children: [
                group.base,
              ...
              harness && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh_mr_ovHarnessDot" }),
                    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh_mr_ovHarnessLabel", children: harnessMeta(harness).label })
                  ]
                }
              ),
              isCurrent && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh_mr_ovCurrent", children: t("overview.current") })
            ] }),
      ...
      isOpen && group.tiers.filter((tier) => tier.key !== group.best.key).map((tier) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh_mr_ovName", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh_mr_ovNameText", children: tier.effort }) }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh_mr_card", children: [
    ...
    scroll ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PersistentScrollFrame, { viewportClassName: "dsh_mr_ovScroll", label: t("overview.title"), children: list }) : list
  ] });
}
...
function LiveCapability({ useSession, modelDirectories, loadData: loadData2, t }) {
  ...
  const tierOptions = (0, import_react4.useMemo)(
  ...
  const capsuleDeltaText = capsuleTrend === null ? "\u2014" : capsuleDirection === "flat" ? "\xB10.0" : `${capsuleTrend.delta24h > 0 ? "+" : ""}${capsuleTrend.delta24h.toFixed(1)}`;
  ...
  const popover = open && anchor !== null ? (0, import_react_dom.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("header", { className: "dsh_mr_popoverHead", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("strong", { className: "dsh_mr_popoverTier", children: [
              viewingSessionTier && match.approximate ? "\u2248 " : "",
              detailTier.model,
              " \xB7 ",
              detailTier.effort
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh_mr_popoverChannel", children: view.scoreLabel })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_mr_popoverBody", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh_mr_badges", children: badges.map((badge) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_mr_badge", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh_mr_badgeVal", "data-accent": badge.accent === true, "data-band": badge.band, children: badge.value }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh_mr_badgeLabel", children: badge.label })
            ] }, badge.label)) }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_mr_card", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_mr_cardHead", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh_mr_cardTitle", children: t("line.title") }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  "select",
                  {
                    ...
                    children: tierOptions.map((candidate) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: candidate.key, children: candidate.label }, candidate.key))
                  }
                )
              ] }),
              detailSeries.length >= 2 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TrendTabs, { points: detailSeries, t }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh_mr_empty", children: t("empty.noSeries") })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_mr_card", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh_mr_cardTitle", children: fmt(t("bar.title"), { label: view.scoreLabel }) }),
              detailTaskRows.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TaskBars, { rows: detailTaskRows, benchmark: view.benchmark, scoringMode: view.scoringMode, t, scroll: false }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh_mr_empty", children: t("empty.none") })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("footer", { className: "dsh_mr_popoverFooter", children: [
            fmt(t("updated"), { time: new Date(view.fetchedAt).toLocaleString() }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("a", { className: "dsh_mr_link", href: SOURCE_SITE_URL, target: "_blank", rel: "noreferrer noopener", children: [
              t("action.openSite"),
              " \u2197"
            ] })
          ] })
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh_mr_liveLabel", children: t("live.label") }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "strong",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dsh_mr_liveDelta", "data-dir": capsuleDirection, children: [
            capsuleArrow,
            " ",
            capsuleDeltaText
          ] })
...
var IQ_MAX = 120;
var AXIS_STYLE2 = { fontSize: 10.5, fill: "var(--dsw-alias-label-secondary)" };
function grouped(points) {
  const ladders = /* @__PURE__ */ new Map();
  for (const point of points) {
    const ladder = ladders.get(point.tier.model);
    if (ladder === void 0) ladders.set(point.tier.model, [point]);
...
function CostPanel({
  ...
  const head = title !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "dsh_mr_trendPanelHead", children: title }) : null;
  if (points.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: "dsh_mr_trendPanel", children: [
      head,
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "dsh_mr_empty", children: t("cost.empty") })
    ] });
  }
  ...
  const innerW = W - PAD2.left - PAD2.right;
  const innerH = H - PAD2.top - PAD2.bottom;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: "dsh_mr_trendPanel", "data-model-focus": focus !== null ? "true" : void 0, children: [
    head,
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dsh_mr_trendWrap", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        "svg",
        {
          ...
          children: [
            iqTicks.map((value) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: PAD2.left, x2: W - PAD2.right, y1: py(value), y2: py(value), stroke: "var(--dsw-alias-border-l1)", strokeDasharray: value === 0 ? "none" : "3 4" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: PAD2.left - 6, y: py(value) + 3.5, textAnchor: "end", style: AXIS_STYLE2, children: value })
            ] }, value)),
            ticks.map((value) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: px(value), x2: px(value), y1: PAD2.top, y2: H - PAD2.bottom, stroke: "var(--dsw-alias-border-l1)", strokeDasharray: "3 4" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: px(value), y: H - 8, textAnchor: "middle", style: AXIS_STYLE2, children: fmtX(metric, value) })
            ] }, value)),
            [...grouped(points).values()].map(
              (ladder) => ladder.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                "path",
                {
            ...
            points.map(({ tier, x }, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              "path",
              {
      ...
      hovered !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        "div",
        {
...
function CostScatterCard({ view, t }) {
  const bases = (0, import_react5.useMemo)(() => {
    const seen = [];
  ...
  const pick = (get, normalize = false) => {
  ...
  const TAB_POINTS = { combined, minutes, price };
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dsh_mr_card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dsh_mr_cardHead", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dsh_mr_costTitleGroup", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "dsh_mr_cardTitle", children: t("cost.title") }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "dsh_mr_hint", children: t("cost.hint") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "dsh_mr_costLegend", children: EFFORT_ORDER.map((effort) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("svg", { viewBox: "0 0 12 12", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("path", { className: "dsh_mr_costSymbol", d: effortShapePath(effort, 6, 6, 4) }) }),
        effort
      ] }, effort)) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dsh_mr_costChips", role: "group", "aria-label": t("cost.filter.all"), children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "dsh_mr_costChip", "data-all": "", onClick: () => setHidden(/* @__PURE__ */ new Set()), children: t("cost.filter.all") }),
      bases.map((base) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "dsh_mr_costChipDot" }),
            base
          ]
        },
        base
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dsh_mr_tabBody", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "dsh_mr_seg", role: "tablist", "aria-label": t("cost.title"), children: COST_METRICS.map((candidate) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CostPanel, { metric, points: TAB_POINTS[metric], focus, t })
    ] })
  ] });
}
...
function RadarSection({ loadData: loadData2, t }) {
  ...
  const autoKey = (0, import_react6.useMemo)(() => view === null ? null : autoMatchTier(view), [view]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "dsh_mr_section", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_header", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { className: "dsh_mr_title", children: t("title") }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_subtitle", children: [
          t("subtitle.pre"),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("a", { className: "dsh_mr_link", href: SOURCE_SITE_URL, target: "_blank", rel: "noreferrer noopener", children: "deng.codexradar.com" }),
          t("subtitle.post")
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh_mr_seg", role: "tablist", "aria-label": t("channel.label"), children: channels.map((channel) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        "button",
        {
          type: "button",
          role: "tab",
    ...
    loading && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_banner", "data-tone": "info", "aria-live": "polite", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dsh_mr_spin" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dsh_mr_bannerText", children: t("status.refreshing") })
    ] }),
    !loading && payload?.stale === true && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_banner", "data-tone": "warn", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dsh_mr_bannerText", children: fmt(t("status.stale"), {
        time: new Date(payload.fetchedAt ?? payload.data?.fetchedAt ?? Date.now()).toLocaleString(),
        reason: payload.notice ?? ""
      }) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "dsh_mr_retry", onClick: () => void load(benchmark), children: t("action.retry") })
    ] }),
    !loading && error !== null && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_banner", "data-tone": "error", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dsh_mr_bannerText", children: fmt(t("status.failed"), { reason: error }) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "dsh_mr_retry", onClick: () => void load(benchmark), children: t("action.retry") })
    ] }),
    view !== null && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TierOverview, { view, selectedKey: tierKey, onSelect: selectTier, t }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh_mr_badges", children: badges.map((badge) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_badge", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dsh_mr_badgeVal", "data-accent": badge.accent === true, "data-band": badge.band, children: badge.value }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dsh_mr_badgeLabel", children: badge.label })
      ] }, badge.label)) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_card", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_cardHead", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dsh_mr_cardTitle", children: t("line.title") }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
            "select",
            {
              ...
              "aria-label": t("line.title"),
              children: [
                tierKey === null && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "", children: "\u2014" }),
                view.tiers.map((candidate) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: candidate.key, children: tierOptionLabel(candidate) }, candidate.key))
              ]
            }
          )
        ] }),
        matchHint !== null && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh_mr_hint", children: matchHint }),
        seriesPoints.length >= 2 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TrendTabs, { points: seriesPoints, t }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh_mr_empty", children: t("empty.noSeries") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_card", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dsh_mr_cardTitle", children: fmt(t("bar.title"), { label: view.scoreLabel || (tier?.passRate != null ? pctText(tier.passRate) : "") }) }),
        taskRows.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TaskBars, { rows: taskRows, benchmark: view.benchmark, scoringMode: view.scoringMode, t }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh_mr_empty", children: t("empty.none") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(CostScatterCard, { view, t }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_footer", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: fmt(t("updated"), { time: new Date(view.fetchedAt).toLocaleString() }) }),
        view.sourceUpdatedAt !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { children: [
          "\xB7 ",
          t("source.updated"),
          ": ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dsh_mr_footerSpacer" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            type: "button",
