...
function MiniTrend({ points }) {
  ...
  const x = (index) => pad + index / (recent.length - 1) * (width - pad * 2);
  const y = (value) => pad + (1 - (value - min) / (max - min)) * (height - pad * 2);
  const segments = buildSegments(values, x, y);
  const lastPoint = [x(recent.length - 1).toFixed(1), y(values[values.length - 1]).toFixed(1)];
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { className: "dsh_mr_liveSpark", viewBox: `0 0 ${width} ${height}`, "aria-hidden": "true", children: [
    segments.map((segment, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      "path",
      {
        d: segment.path,
        fill: "none",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("circle", { cx: lastPoint[0], cy: lastPoint[1], r: "1.8", fill: bandColor(iqBand(values[values.length - 1])) })
  ] });
}
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_mr_popoverBody", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_mr_card", children: [
              ...
              detailSeries.length >= 2 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TrendLine, { points: detailSeries, t }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh_mr_empty", children: t("empty.noSeries") })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_mr_card", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(MiniTrend, { points: capsuleSeries })
        ]
      }
    ),
    popover
