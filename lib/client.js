...
function tierGroupsForView(tiers) {
  const byBase = /* @__PURE__ */ new Map();
  for (const tier of tiers) {
    const ladder = byBase.get(tier.model);
    if (ladder === void 0) byBase.set(tier.model, [tier]);
  ...
  for (const [base, ladder] of byBase) {
    ...
    groups.push({
      base,
      label: harness === null ? base : `${base} \xB7 ${harnessMeta(harness).label}`,
...
function LiveCapability({ useSession, modelDirectories, loadData: loadData2, t }) {
  ...
  const tierGroups = (0, import_react4.useMemo)(() => tierGroupsForView(view?.tiers ?? []), [view]);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "section",
      {
        ...
        children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_mr_cardHead", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  "select",
                  {
                    ...
                    children: tierGroups.map((group) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("optgroup", { label: group.label, children: group.tiers.map((candidate) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("option", { value: candidate.key, children: [
                      candidate.effort,
                      " \xB7 IQ ",
                      candidate.iq.toFixed(1)
                    ] }, candidate.key)) }, group.base))
                  }
                )
              ] }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("footer", { className: "dsh_mr_popoverFooter", children: fmt(t("updated"), { time: new Date(view.fetchedAt).toLocaleString() }) })
        ]
      }
    ),
    document.body
...
function CostScatterCard({ view, t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dsh_mr_card", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dsh_mr_costChips", role: "group", "aria-label": t("cost.filter.all"), children: [
      ...
      bases.map((base) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        "button",
        {
          ...
          onClick: () => toggle(base),
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "dsh_mr_costChipDot", style: { background: modelColor(base) } }),
            base
          ]
        },
        base
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dsh_mr_tabBody", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CostPanel, { metric, points: TAB_POINTS[metric], t })
    ] })
  ] });
}
...
function RadarSection({ loadData: loadData2, t }) {
  ...
  const tierGroups = (0, import_react6.useMemo)(() => view === null ? [] : tierGroupsForView(view.tiers), [view]);
  const badges = [
    {
      label: t("badge.iq"),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "dsh_mr_section", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh_mr_header", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh_mr_subtitle", children: t("subtitle") })
      ] }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
            "select",
            {
              ...
              children: [
                ...
                tierGroups.map((group) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("optgroup", { label: group.label, children: group.tiers.map((candidate) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("option", { value: candidate.key, children: [
                  candidate.effort,
                  " \xB7 IQ ",
                  candidate.iq.toFixed(1)
                ] }, candidate.key)) }, group.base))
