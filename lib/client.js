...
var OWN_HARNESS_PREFIX = "dsh-";
function foldSeparators(token) {
  return token.replace(/[^a-z0-9]+/g, "");
}
function normalizeModelToken(model) {
  return foldSeparators(model.split("/").pop()?.trim().toLowerCase() ?? model.toLowerCase());
}
function findTier(tiers, token, effort) {
  return tiers.find(
    (tier) => normalizeModelToken(tier.model) === token && (effort === void 0 || tier.effort.toLowerCase() === effort)
  );
}
function isNamesake(tier, token) {
  const normalized = normalizeModelToken(tier.model);
  return normalized.includes(token) || token.includes(normalized);
}
function resolveToken(tiers, model, effort) {
...
function singlePointSpan(testTs, nowTs) {
...
function TrendPanel({
  ...
  const geometry = (0, import_react3.useMemo)(() => {
    ...
    const baseline2 = PLOT_H - PAD.bottom;
    const bandLines2 = BAND_BOUNDARIES.map((boundary) => ({ boundary, py: y2(boundary) })).filter(({ py }) => py >= PAD.top - 0.5 && py <= PLOT_H - PAD.bottom + 0.5);
    if (points.length === 1) {
    ...
    return {
      ...
      segments: buildSegments(points.map(([, value]) => value), x, y2)
    };
  }, [points]);
  ...
  const hovered = hover !== null ? points[hover.index] : void 0;
  ...
  const singleLabelAnchor = single !== null && single.pointX > PLOT_W - PAD.right - 60 ? "end" : "start";
  const onMove = (event) => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        "svg",
        {
          ...
          children: [
            ...
            multi !== null && multi.segments.map((segment, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("g", { children: [
            ...
            single !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "path",
                {
            ...
            hovered !== void 0 && hover !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("line", { x1: hover.px, x2: hover.px, y1: PAD.top, y2: PLOT_H - PAD.bottom, stroke: "var(--dsw-alias-border-l2)" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("circle", { cx: hover.px, cy: y(hovered[1]), r: "3", fill: "var(--dsw-alias-bg-layer-1)", stroke: bandColor(iqBand(hovered[1])), strokeWidth: "2" })
            ] }),
            multi !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("circle", { cx: multi.x(multi.last), cy: endpointY, r: "3.8", fill: endpointColor }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("text", { x: multi.x(multi.last), y: endpointY - 9, textAnchor: "end", style: { ...AXIS_STYLE, fontWeight: 600, fill: "var(--dsw-alias-label-primary)" }, children: endpointValue.toFixed(1) })
            ] }),
            single !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("circle", { cx: single.pointX, cy: endpointY, r: "3.8", fill: endpointColor }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("text", { x: single.pointX, y: endpointY - 9, textAnchor: singleLabelAnchor, style: { ...AXIS_STYLE, fontWeight: 600, fill: "var(--dsw-alias-label-primary)" }, children: single.value.toFixed(1) })
            ] }),
            multi !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("text", { x: PAD.left, y: PLOT_H - 8, style: AXIS_STYLE, children: formatStamp(points[0][0], false) }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("text", { x: PLOT_W - PAD.right, y: PLOT_H - 8, textAnchor: "end", style: AXIS_STYLE, children: formatStamp(points[multi.last][0], false) })
            ] }),
            single !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("text", { x: PAD.left, y: PLOT_H - 8, style: AXIS_STYLE, children: formatStamp(single.loTs, true) }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("text", { x: PLOT_W - PAD.right, y: PLOT_H - 8, textAnchor: "end", style: AXIS_STYLE, children: formatStamp(single.hiTs, true) })
            ] })
          ]
        }
      ),
      hovered !== void 0 && hover !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(PlotTip, { x: hover.px, y: y(hovered[1]), width: PLOT_W, height: PLOT_H, children: [
...
function TrendCard({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dsh_mr_card", children: [
    ...
    points.length >= 1 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TrendTabs, { points, t }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "dsh_mr_empty", children: t("empty.noSeries") })
  ] });
}
function TaskCard({
  view,
...
function LiveCapability({ useSession, modelDirectories, loadData: loadData2, t }) {
  ...
  const selectionAlias = (0, import_react4.useMemo)(() => {
    ...
    for (const group of directoryState.groups) {
      ...
      if (entry !== void 0 && entry.name !== "" && entry.name !== entry.id) return entry.name;
    }
    return void 0;
  }, [directoryState.groups, selection]);
  const match = (0, import_react4.useMemo)(
    () => view === null || selection === null ? null : matchTier(view, selectionAlias === void 0 ? selection : { ...selection, aliases: [selectionAlias] }),
