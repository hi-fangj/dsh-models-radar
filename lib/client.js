...
function RadarSection({ loadData: loadData2, loadRatings: loadRatings2, t }) {
  ...
  const [selectedKey, setSelectedKey] = (0, import_react7.useState)(() => localStorage.getItem(tierStorageKey(benchmark)));
  (0, import_react7.useEffect)(() => {
    setSelectedKey(localStorage.getItem(tierStorageKey(benchmark)));
  }, [benchmark]);
  const autoKey = (0, import_react7.useMemo)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("section", { className: "dsh_mr_section", children: [
    ...
    view !== null && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TierOverview, { view, selectedKey: tierKey, onSelect: selectTier, t }),
